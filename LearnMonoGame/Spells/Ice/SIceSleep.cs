...
{
    class SIceSleep : Spell
    {
        public SIceSleep(EAlignment _alignment) : base(SpellManager.Instance.spellInformation["SIceSleep"], _alignment)
        {
        }
        ...
        public override void Cast(Vector2 bounds, Vector2 _direction, Character me)
        {
            if (CastAble(me, bounds, _direction))
            {
                ...
                c.ApplyEffect(SpellManager.Instance.attackInformation["IceSleep"]);
